...
public class AliOSSUtil {
    ...
    public static String ossUpload(File file) {
        String bucketDomain = "https://soft1841-yj.oss-cn-beijing.aliyuncs.com/";
        //Endpoint以北京为例，其它Region请按实际情况填写
        String endpoint = "http://oss-cn-beijing.aliyuncs.com";
        //accessKeyId和accessKeySecret，请填写自己的
        String accessKeyId = "LTAIPg5kqumfgHyl";
        String accessKeySecret = "hC65qJp1OFzqhFTOu8opJteu6mEMBm";
        //Bucket名称
        String bucketName = "soft1841-yj";
        //目录名称
        String filedir = "img/";
        //获得本地文件的文件名
